...
const HomeCTA = () => {
  return (
    <section className="py-24 px-6 md:px-12 bg-[#FAF7F2] font-sans border-b border-[#F2D9A0] relative overflow-hidden">
      <div className="max-w-7xl mx-auto bg-gradient-to-br from-[#F2E5C6] via-white to-[#F2D9A0]/70 rounded-3xl p-10 md:p-20 text-center text-[#3B010B] relative overflow-hidden shadow-2xl border-2 border-[#F2D9A0]">
        ...
        <div className="absolute inset-0 bg-texture-grain opacity-60 pointer-events-none" />
        ...
        <div className="relative z-10 space-y-8">
          <div className="inline-flex items-center gap-2 text-[#75162D] text-xs font-bold uppercase tracking-widest bg-[#F2D9A0]/60 px-4 py-1.5 rounded-full border border-[#75162D]/30 backdrop-blur-md shadow-xs font-display">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 pt-4">
            <a 
              ...
              className="bg-white text-[#3B010B] border-2 border-[#25D366]/50 px-8 py-4 rounded-xl font-bold text-sm hover:bg-white hover:border-[#25D366] hover:shadow-xl hover:-translate-y-0.5 transition-all shadow-md flex items-center justify-center gap-2.5 uppercase tracking-wider font-display"
            >
              <FaWhatsapp className="text-[#25D366] text-2xl flex-shrink-0" />
              <span>WHATSAPP DESK (+263 775 040 725)</span>
            </a>
            <Link to="/contact" className="bg-[#75162D] text-[#F2E5C6] px-8 py-4 rounded-xl font-bold text-sm hover:bg-[#3B010B] hover:text-[#F2D9A0] hover:-translate-y-0.5 transition-all shadow-xl flex items-center justify-center uppercase tracking-wider font-semibold font-display border border-[#F2D9A0]/30">
              REQUEST A QUOTE
            </Link>
            <Link to="/services" className="border-2 border-[#F2D9A0] bg-white text-[#3B010B] px-8 py-4 rounded-xl font-semibold text-sm hover:bg-[#F2E5C6] hover:border-[#75162D] hover:-translate-y-0.5 transition-all flex items-center justify-center uppercase tracking-wider backdrop-blur-sm font-display shadow-sm">
              VIEW PACKAGES
            </Link>
          </div>
        </div>
